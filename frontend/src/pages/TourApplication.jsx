...
const TourApplication = () => {
  ...
  const validateStep = () => {
    switch (step) {
      ...
      case 3:
        return formData.city && formData.district  && ((formData.tourType === "individual" && formData.studentHighSchool) || (formData.studentCount && formData.schoolName)) ;
      default:
        return true;
    }
  };
  ...
  return (
    <section className="tour-application-section">
      <div className="tour-application-container">
        ...
        { step === 0 &&<p className="tour-application-description">
        ...
        <form onSubmit={handleSubmit} className={`tour-application-form `}>
          {step === 0 && (
            <div className={`tour-type-selection ${step === 0 ? 'step-enter' : 'step-exit'}`}>
              <button
                type="button"
          ...
          {step === 2 && (
            ...
            <div className={step === 2 ? 'step-enter' : 'step-exit'}>
              {formData.tourType === "individual" ? (
                ...
                <CustomDateTimePicker handleChange={handleChange} reserveDatesImp={formData.reserveDates}/>
              )}
              </div>
            </>
          )}
          ...
          {step === 4 && (
            ...
            <div className={`confirmation-step   ${step === 4 ? 'step-enter' : 'step-exit'}`}>
              ...
              <p><strong>School Name:</strong> {formData.schoolName}</p>
                <p><strong>Number of Students:</strong> {formData.studentCount}</p>
                </>
              )}
              {formData.tourType === "individual" && (
                <>
                <p><strong>High School:</strong> {formData.studentHighSchool}</p>
                <p><strong>Major of Interest:</strong> {formData.majorOfInterest}</p>
                </>
              )}
          ...
          <div className="form-navigation">
            ...
            {step === 4 && (
              <button type="submit" className="tour-application-submit" id="submitButton">
                Submit Application
              </button>
            )}
          </div>
